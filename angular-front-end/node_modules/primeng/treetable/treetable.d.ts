...
import { BlockableUI, FilterMetadata, FilterService, PrimeNGConfig, PrimeTemplate, ScrollerOptions, SortMeta, TreeNode, TreeTableNode } from 'primeng/api';
...
export declare class TreeTableToggler {
    ...
    private config;
    rowNode: any;
    constructor(tt: TreeTable, config: PrimeNGConfig);
